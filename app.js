	...
	app = {
		...
		'dict':{
			'en':{
				...
				'comprehensKeyDesc':"On keyboard we write couple lines of </code> but in reality we solve problems. The better we understand the problem, relevant is the solution",	
				'codeuniversal':"Code is universal, Users are different",
				'codeuniversaldescr':"We use the same programming languages, the same framework, libraries and tools to serve different customers. We customize as needed",
				'dowhatulov':"Do what you love, love what you do",
				'dowhatulovdescr':"Every member in the team has passed more than 5 years studying and working on different projects just for fun. For us, programming is far from earning money. Programming is the part of our life, It makes us feel happy",
				'handwithudev':"Who we are without our community? We work hand in hand with UDEV TEAM.",
				...
				'fr':{
				'lang':"Français",
				'textArray' : ['des problèmes en solutions.', ' on change des questions en réponses.', ' des idées en realité.'],
				'transf':"On change ",
				'values':"Valeurs",                            
				'team':"Equipe",                            
				'portfolio':"Portfolio",                            
				...
				'codeuniversaldescr':"Nous utilisons les mêmes langages de programmation, le même cadre, les mêmes bibliothèques et outils pour servir différents clients avec différents besoins. Nous personnalisons au besoin",
			...
			'rn':{
				...
				'designGeniDesc':"Kuki twotunga ibitabereye ijisho kandi bishoboka ko dukora igihushane cavyo? turi neza kandi dukunda ibibereye ijisho.",
				...
				'codeuniversal':"kode ni mpuzamakungu, abayandika bagatandukana",
